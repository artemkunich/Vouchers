...
import { ListHeader } from '../common/list/list'
import { CreateDomainOfferCommand } from '../../types/commands'
import "bootstrap-icons/font/bootstrap-icons.css";

interface DomainOffersListNewElementProps {
    postDomainOffer: (command: CreateDomainOfferCommand) => Promise<string | undefined>
}

export const DomainOffersListNewElement = ({postDomainOffer}: DomainOffersListNewElementProps) => {

    const [newOffer, setNewOffer] = React.useState<CreateDomainOfferCommand>({
        name: "",
        maxMembersCount: 0,
        amount: 0,
        currency: "CZK",
        ...
        <div className="container">
            ...
            <div className="row mb-2">
                ...
                <div className="col-3">
                    ...
                    <select id="domainOfferInvoicePeriod" className="form-select" value={newOffer.invoicePeriod} onChange={event => setNewOffer({...newOffer, invoicePeriod: event.target.value})}>
