...
const Navbar = (props) => {
    ...
    const identityDetailImageSrc = identityDetail.croppedImageBase64 ? `data:image/png;base64,${identityDetail.croppedImageBase64}` : noprofileImageSrc
