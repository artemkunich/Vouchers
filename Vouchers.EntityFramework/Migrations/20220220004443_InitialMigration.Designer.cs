...
namespace Vouchers.EntityFramework.Migrations
{
    ...
    [Migration("20220220004443_InitialMigration")]
            ...
            modelBuilder.Entity("Vouchers.Values.VoucherValueDetail", b =>
                {
                    ...
                    b.Property<Guid>("VoucherValueId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("VoucherValueId");

                    b.HasKey("Id");

                    b.HasIndex("DomainId");

                    b.HasIndex("VoucherValueId")
                        .IsUnique();
