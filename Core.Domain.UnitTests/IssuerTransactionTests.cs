...
public class IssuerTransactionTests
{
    ...
    public IssuerTransactionTests()
    {
        ...
        _issuerAccount = Account.Create(issuerAccountId, issuerIdentityId, DateTime.Now);
        
        var holderIdentityId = Guid.NewGuid();
        var holderAccountId = Guid.NewGuid();
        _holderAccount = Account.Create(holderAccountId, holderIdentityId, DateTime.Now);
